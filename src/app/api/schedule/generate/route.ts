...
/**
 * Triggered by the Thursday 5pm pg_cron job: runs the scheduling
 * algorithm and creates the next Week + Shift rows in DRAFT, then
 * notifies the professor.
 *
 ...
 * <secret>`. The professor's "Generate schedule" button is the
